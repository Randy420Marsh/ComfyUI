...
INTERVAL = 0.1 # Time in seconds between readings (reduced for potentially smoother updates)
MAX_POINTS = 500 # Maximum number of data points to show on the graph (increased to show more history)
